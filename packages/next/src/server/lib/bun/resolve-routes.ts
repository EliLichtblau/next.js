import type { FsOutput } from '../router-utils/filesystem'
import type { IncomingMessage, ServerResponse } from 'http'
import type { NextConfigComplete } from '../../config-shared'
import type { RenderServer, initialize } from './render-server'
...
export function getResolveRoutes(
  fsChecker: UnwrapPromise<
    ReturnType<typeof import('../router-utils/filesystem').setupFsCheck>
  >,
